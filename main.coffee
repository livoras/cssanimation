...
tl.to ".box", 0.5, {x: 50, y: 200, scaleX: 1, scaleY: 1, "background-color": "red", "rotationZ": 360} 
  ...
  .set ".box2", {"border": "100px solid #ccc"}
  .delay 2
...
# tl.to ".box2", 0.5, {x: 100, y: 200, scaleX: 1.5, scaleY: 1.5}
#   .to ".box2", 0.5, {rotationZ: 720, scaleY: 3, scaleX: 3, "background-color": "red", "border-radius": "100px"}
#   .to ".box2", 0.3, {scaleX: 1, scaleY: 1}
#   .to ".box2", 0.2, {scaleX: 1.5, scaleY: 1.5}
#   .to ".box2", 0.3, {scaleX: 0.7, scaleY: 0.7}
#   .to ".box2", 0.2, {scaleX: 1, scaleY: 1}
